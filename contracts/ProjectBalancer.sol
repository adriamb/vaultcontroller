...
contract ProjectBalancer is Owned {
    ...
    function ProjectBalancer(
        ...
        mainVault = new Vault(baseToken, escapeHatchCaller, escapeHatchDestination, 0,0,0,0);
    }
    ...
    function createProject(
        ...
        project.vault = new Vault(baseToken, escapeHatchCaller, escapeHatchDestination, 0,0,0,0);
